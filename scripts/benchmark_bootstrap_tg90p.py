...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--safe-tile-memory",
        default=None,
        help="Set ICCLIM_BOOTSTRAP_SAFE_TILE_MEMORY, e.g. 512MB or 2GB.",
    )
    parser.add_argument(
        "--safe-tile-cells",
        default=None,
        help="Set ICCLIM_BOOTSTRAP_SAFE_TILE_CELLS expert override.",
    )
    parser.add_argument(
        "--cache-dir",
        type=Path,
...
def main() -> None:
    ...
    with (
        _temporary_env(
            ICCLIM_BOOTSTRAP_MODE=args.bootstrap_mode,
            ICCLIM_BOOTSTRAP_SAFE_TILE_MEMORY=args.safe_tile_memory,
            ICCLIM_BOOTSTRAP_SAFE_TILE_CELLS=args.safe_tile_cells,
        ),
    ...
    summary: dict[str, object] = {
        ...
        "safe_tile_memory": args.safe_tile_memory,
        "safe_tile_cells": args.safe_tile_cells,
